...
namespace SystemicDesign
{
    ...
    class PopupEditor : EditorWindow
    {
        ...
        private static string defaultYesMessage = "Yeah!";                      ///Mensaje por defecto escrito en el botón de sí, se modifica si se usa ciertos constructores
        private static string defaultNoMessage = "Hell no!";                    ///Mensaje por defecto escrito en el botón de no, se modifica si se usa ciertos constructores
