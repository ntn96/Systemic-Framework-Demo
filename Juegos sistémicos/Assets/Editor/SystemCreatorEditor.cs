...
namespace SystemicDesign
{
    ...
    public class SystemCreatorEditor : EditorWindow
    {
        ...
        {
            window = GetWindow<SystemCreatorEditor>("Systemic Editor");
            rootSystem = root;
        ...
        {
            if (window == null) window = GetWindow<SystemCreatorEditor>("Systemic Editor");
            if (redStyle == null)
            {
                redStyle = new GUIStyle(EditorStyles.label);
                redStyle.normal.textColor = Color.red;
        ...
        private void OnGUI()
        {
            ...
            if (rootSystem != null)
            {
                ...
                if (GUILayout.Button("Crear sistema"))
                {
                ...
                if (badID) GUILayout.Label("La ID del sistema a crear es incorrecta o ya está siendo utilizada", redStyle);
            }
        }
        ...
        {
            GUILayout.Label("Editor de sistemas", EditorStyles.boldLabel);
            GUILayout.BeginHorizontal();
            GUILayout.BeginVertical();
            GUILayout.Label("Nombre del nuevo sistema:");
            GUILayout.Label("ID del nuevo sistema:");
